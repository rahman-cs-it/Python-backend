    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='chai.chaivarity')),
            ],
        ),
        migrations.CreateModel(
            name='Stores',
            fields=[
                ...
                ('chai_variteies', models.ManyToManyField(related_name='stores', to='chai.chaivarity')),
            ],
        ),
    ]
